...
- **PROFINET:** gateway-supported (6H); native Hilscher scaffolding **SOFTWARE-INTEGRATION TESTED** / **HARDWARE VALIDATION PENDING** (ICP-1B does not change this boundary).
- **PROFIBUS:** gateway-supported; native Hilscher scaffolding **SOFTWARE-INTEGRATION TESTED** / **HARDWARE VALIDATION PENDING**.

...
| — | [hilscher-environment-audit.md](hilscher-environment-audit.md) | Hilscher environment/SDK audit. |
| — | [hilscher-sdk-license.md](hilscher-sdk-license.md) | NXDRV-LINUX licenses vs firmware/master license. |
| — | [hilscher-hardware-smoke-test.md](hilscher-hardware-smoke-test.md) | Hardware checklist — **PENDING**. |
| — | [native-fieldbus-implementation-status.md](native-fieldbus-implementation-status.md) | Native PN/PB status (cifX software vs hardware). |
